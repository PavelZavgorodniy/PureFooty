...
namespace PureFooty.Entities
{
	public partial class Player : PositionedObject, IDestroyable
	{
		...
		private static Scene PlayerImage;
		...
		protected virtual void InitializeEntity(bool addToManagers)
		{
			...
			Body = PlayerImage.Sprites.FindByName("character boy1").Clone();
...
// Generated AddToManagers
		...
		public virtual void Destroy()
		{
			...
			if (Body != null)
			{
				SpriteManager.RemoveSprite(Body); Body.Detach();
			}
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (IsStaticContentLoaded == false)
			{
				...
				if (!FlatRedBallServices.IsLoaded<Scene>(@"content/playerimage.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				PlayerImage = FlatRedBallServices.Load<Scene>(@"content/playerimage.scnx", ContentManagerName);
		...
		public static void UnloadStaticContent ()
		{
			...
			if (PlayerImage != null)
			{
				PlayerImage.RemoveFromManagers(ContentManagerName != "Global");
				PlayerImage= null;
			}
		}
